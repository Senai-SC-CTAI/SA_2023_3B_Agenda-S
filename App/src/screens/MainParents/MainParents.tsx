    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity onPress={() => openScreen('PSaidaAntecipada')} style={styles.button}>
                ...
                <TouchableOpacity onPress={() => openScreen('PSolicitarSaida')} style={styles.button}>
                    <View style={styles.buttonContent}>
                ...
                <TouchableOpacity onPress={() => openScreen('PChegadaAtrasada')} style={styles.button}>
                    <View style={styles.buttonContent}>
                ...
                <TouchableOpacity onPress={() => openScreen('PRequests')} style={styles.button}>
                    <View style={styles.buttonContent}>
